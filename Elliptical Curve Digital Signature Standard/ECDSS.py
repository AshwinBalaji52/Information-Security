...
def signing(a, d, r, e1, prime_q, plainText):
    result_P = addPoints(a, prime_q, r, e1) #P(u, v) & u%q = s1
    print("\nP(U, V):", result_P)
    s1 = result_P[0] % prime_q
    #print("S1 : ", s1)
    inverse_r = extendedEuclidean(r, prime_q)[1] #in tuple 1st position is the actual inverse value
    #print(inverse_r)
...
def main():
    ...
    signature1, signature2 = signing(a, d, r, e1, prime_q, plainText)
